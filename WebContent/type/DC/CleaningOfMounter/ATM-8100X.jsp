...
<html>
	...
	<head>
		...
		<title>ウエハマウンタ清掃チェックシート（ＡＴＭ－８１００Ｘ）</title>
	</head>

	<body>
		<% request.setCharacterEncoding("UTF-8");%>
		<div class="block">ウエハマウンタ清掃チェックシート（ＡＴＭ－８１００Ｘ）</div>
		<jsp:include page="/include/include_pagetop.jsp"/>
		<form id="fm" action="<%=request.getContextPath()%>/TenkenListServlet" method="post">
			<input type="hidden" name="sheetnm" value="ウエハマウンタ清掃チェックシート（ＡＴＭ－８１００Ｘ）">
					...
					<tr>
						<td>
							<table>
								...
								<tr>
									<td>1</td><td>ウエハ搬送アーム部（前面）</td><td>20秒</td><td>1回/日</td>
									<td>
								...
								<tr>
									<td>2</td><td>仮置きステーション及び周辺（前面）</td><td>20秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>3</td><td>キャリアステーション部及び周辺（前面）</td><td>20秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
						...
						<td>
							<table>
								...
								<tr>
									<td>9</td><td>剥離テーブル部及び周辺（左側面）</td><td>20秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>10</td><td>剥離ユニット部</td><td>20秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>11</td><td>アンローダ部搬送レール（左側面）</td><td>20秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>12</td><td>マガジンセット部<br/>テフロンシート（前面）</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>13</td><td>段取り作業机（右側面）</td><td>1分</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>14</td><td>装置外装<br/>(正面・側面・背面・上部・下部・モニタ・計器)</td><td>7分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
