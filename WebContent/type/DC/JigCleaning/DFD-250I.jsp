					...
					<tr>
						<td>
							<table>
								...
								<tr>
									<td>1</td><td>ローダ　※テフロンシート/導電マット</td><td>30秒</td><td>1回/日</td>
									<td>
								...
								<tr>
									<td>2</td><td>トレイステージ</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>3</td><td>リングステージ</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>4</td><td>作業机</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>5</td><td>装置内</td><td>3分</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>6</td><td>マッピングシステムP/C</td><td>1分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>7</td><td>装置外装<br/> (正面・側面・背面・上部・下部・モニタ・P/C・計器)</td><td>4分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
