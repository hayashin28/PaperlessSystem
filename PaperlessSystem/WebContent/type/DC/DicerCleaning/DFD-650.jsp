...
<html>
	...
	<head>
		...
		<title>ダイサー清掃チェックシート（ＤＦＤ－６５０／６５１）</title>
	</head>

	<body>
		<% request.setCharacterEncoding("UTF-8");%>
		<div class="block">ダイサー清掃チェックシート（ＤＦＤ－６５０／６５１）</div>
		<jsp:include page="/include/include_pagetop.jsp"/>
		<form id="fm" action="<%=request.getContextPath()%>/TenkenListServlet" method="post">
			<input type="hidden" name="sheetnm" value="ダイサー清掃チェックシート（ＤＦＤ－６５０／６５１）">
					...
					<tr>
						<td>
							<table>
								...
								<tr>
									<td>1</td><td>搬送部・搬送ステージ/※テフロンシート</td><td>30秒</td><td>1回/日</td>
									<td>
								...
								<tr>
									<td>2</td><td>搬送部・搬送レール</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>3</td><td>搬送部・ロータリーアーム/直動アーム</td><td>1分</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>4</td><td>スピンナ部・スピンナテーブル周辺</td><td>45秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>5</td><td>チャックテーブル側面・クランプ</td><td>3分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>6</td><td>スピンナ部・スピンナ内</td><td>3分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>7</td><td>カッティング部・カッティング内/ホース/ジャバラ</td><td>2分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>8</td><td>カッティング部・アクリルカバー内側</td><td>2分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>9</td><td>装置外装・正面/側面/上部/下部/モニタ/SW</td><td>5分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
