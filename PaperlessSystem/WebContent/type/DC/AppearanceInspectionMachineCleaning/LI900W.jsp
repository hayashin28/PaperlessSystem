...
<html>
	...
	<head>
		...
		<title>自動外観検査機清掃チェックシート（ＬＩ９００Ｗ）</title>
	</head>

	<body>
		<% request.setCharacterEncoding("UTF-8");%>
		<div class="block">自動外観検査機清掃チェックシート（ＬＩ９００Ｗ）</div>
		<jsp:include page="/include/include_pagetop.jsp"/>
		<form id="fm" action="<%=request.getContextPath()%>/TenkenListServlet" method="post">
			<input type="hidden" name="sheetnm" value="自動外観検査機清掃チェックシート（ＬＩ９００Ｗ）">
				...
				<table class="table table-hover">
					...
					<tr>
						<td>
							<table>
								<tr>
									<td></td><td>清掃箇所</td><td>頻度</td><td>清掃確認結果</td>
								</tr>
								<tr>
									<td>1</td><td>ローダトレイセット部</td><td>1回/日</td>
									<td>
								...
								<tr>
									<td>2</td><td>ローダ部吸着パッド</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>3</td><td>検査ステージ1</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>4</td><td>中間吸着ステージ</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>5</td><td>検査ステージ2</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
						...
						<td>
							<table>
								...
								<tr>
									<td>6</td><td>アンローダ部吸着パッド</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>7</td><td>検査ステージ3</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>8</td><td>アンローダトレイセット部</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>9</td><td>装置内ベース部</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>10</td><td>天井、カバー類</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>11</td><td>装置の下、周辺</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
