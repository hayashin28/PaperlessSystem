...
<html>
	...
	<head>
		...
		<title>Ｋ＆Ｓ　ワイヤボンダ清掃チェックシート</title>
	</head>

	<body>
		<div class="block">Ｋ＆Ｓ　ワイヤボンダ清掃チェックシート</div>
		<jsp:include page="/include/include_pagetop.jsp"/>
		<form id="fm" action="<%=request.getContextPath()%>/TenkenListServlet" method="post">
			<input type="hidden" name="sheetnm" value="Ｋ＆Ｓ　ワイヤボンダ清掃チェックシート">
			...
			<div class="bs-example table-responsive">
				...
				<jsp:include page="/include/include_lastcleaningdata.jsp"/>
				...
				<table class="table table-hover">
					...
					<tr>
						<td>
							<table border="1">
								<tr>
									<td>01</td><td rowspan=10>清掃頻度<br/>（週）</td><td>顕微鏡、ハンドル、照明アーム部</td><td rowspan=10>11</td><td rowspan=10>ｷｬﾋﾟﾗﾘ<br/>交換時</td><td rowspan=10>クランパ部</td><td rowspan=3>12</td><td rowspan=10>清掃頻度<br/>（月）</td><td rowspan=3>装置全体</td><td rowspan=10>16</td><td rowspan=10>清掃頻度<br/>（月）</td><td rowspan=10>搬送レール部</td>
								</tr>
								<tr>
									<td>02</td><td>I/Lﾏｶﾞｼﾞﾝ受け部　※</td>
								</tr>
								<tr>
									<td>03</td><td>I/Lﾏｶﾞｼﾞﾝ払出し部　※</td>
								</tr>
								<tr>
									<td>04</td><td>U/Lﾏｶﾞｼﾞﾝ受け部　※</td><td rowspan=3>13</td><td rowspan=3>I/L ﾗｯｸﾎｰﾙﾄﾞPaw部</td>
								</tr>
								<tr>
									<td>05</td><td>U/Lﾏｶﾞｼﾞﾝ払出し部　※</td>
								</tr>
								<tr>
									<td>06</td><td>ﾏｳｽﾊﾟｯﾄ、ｵﾍﾟﾚｰｼｮﾝﾊﾟﾈﾙ部</td>
								</tr>
								<tr>
									<td>07</td><td>金線経路部</td><td rowspan=2>14</td><td rowspan=2>U/L ﾗｯｸﾎｰﾙﾄﾞPaw部</td>
								</tr>
								<tr>
									<td>08</td><td>金線屑回収</td>
								</tr>
								<tr>
									<td>09</td><td>脇机部</td><td rowspan=2>15</td><td rowspan=2>ヒータプレート部</td>
								</tr>
								<tr>
