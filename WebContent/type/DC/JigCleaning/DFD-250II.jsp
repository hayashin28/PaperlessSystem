					...
					<tr>
						<td>
							<table>
								...
								<tr>
									<td>1</td><td>ローダ（前面）※テフロンシート/導電マット</td><td>30秒</td><td>1回/日</td>
									<td>
								...
								<tr>
									<td>2</td><td>トレイステージ手前</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>3</td><td>トレイステージ奥</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>4</td><td>リングステージ</td><td>2分</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>5</td><td>作業机（装置左側)</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>6</td><td>装置外装<br/> (正面・側面・背面・上部・下部・モニタ・P/C・計器)</td><td>5分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
