...
<html>
	...
	<head>
		...
		<title>ダイサ（ＤＦＤ６０００シリーズ）インチ切替チェックシート</title>
	</head>

	<body>

		<% request.setCharacterEncoding("UTF-8");%>
		<div class="block">ダイサ（ＤＦＤ６０００シリーズ）インチ切替チェックシート</div>
		<jsp:include page="/include/include_pagetop.jsp"/>
		<form id="fm" action="<%=request.getContextPath()%>/TenkenListServlet" method="post">
			<input type="hidden" name="sheetnm" value="ダイサ（ＤＦＤ６０００シリーズ）インチ切替チェックシート">
					...
					<tr>
						<td>
							<table>
								...
								<tr>
									<td rowspan=2>ロア<br/>アーム</td>
									<td>
										<jsp:include page="/include/include_inputtextex_required.jsp">
											<jsp:param name="btn"	 value="btn_03" />
											<jsp:param name="disp"	 value="ﾛｱｱｰﾑ幅吸着ﾊﾟｯﾄﾞ" />
