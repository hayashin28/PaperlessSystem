...
<html>
	...
	<head>
		...
		<title>ウエハマウンタ清掃チェックシート（ＭＡ３０００Ⅱ）</title>
	</head>

	<body>
		<% request.setCharacterEncoding("UTF-8");%>
		<div class="block">ウエハマウンタ清掃チェックシート（ＭＡ３０００Ⅱ）</div>
		<jsp:include page="/include/include_pagetop.jsp"/>
		<form id="fm" action="<%=request.getContextPath()%>/TenkenListServlet" method="post">
			<input type="hidden" name="sheetnm" value="ウエハマウンタ清掃チェックシート（ＭＡ３０００Ⅱ）">
					...
					<tr>
						<td>
							<table>
								...
								<tr>
									<td>1</td><td>ローダステージ</td><td>30秒</td><td>1回/日</td>
									<td>
								...
								<tr>
									<td>2</td><td>ロボットアーム</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>3</td><td>アライナー</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>4</td><td>吸着テーブル上</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>5</td><td>貼付部搬送レール</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>6</td><td>貼付後搬送部</td><td>60秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
						...
						<td>
							<table>
								...
								<tr>
									<td>7</td><td>アンローダ搬送部</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>8</td><td>アンローダステージ<br/>※テフロンシート</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>9</td><td>作業段取机</td><td>30秒</td><td>1回/日</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>10</td><td>テープ交換部</td><td>1分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>11</td><td>フレーム供給台車</td><td>2分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
								...
								<tr>
									<td>12</td><td>装置外装<br/>(正面・側面・背面・上部・下部・モニタ・計器)</td><td>7分</td><td>1回/週</td>
									<td>
										<jsp:include page="/include/include_twoswitch.jsp">
