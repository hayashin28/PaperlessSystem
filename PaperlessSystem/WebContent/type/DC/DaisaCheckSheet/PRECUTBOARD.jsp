...
<html>
	...
	<head>
		...
		<title>PRECUT BOARDチェックシート</title>
	</head>

	<body>

		<% request.setCharacterEncoding("UTF-8");%>
		<div class="block">ＰＲＥＣＵＴ　ＢＯＡＲＤチェックシート</div>
		<jsp:include page="/include/include_pagetop.jsp"/>
		<form id="fm" action="<%=request.getContextPath()%>/TenkenListServlet" method="post">
			<input type="hidden" name="sheetnm" value="ＰＲＥＣＵＴ　ＢＯＡＲＤチェックシート">
								...
								<tr>
									<td>
										<jsp:include page="/include/include_inputtextex_required.jsp">
											...
											<jsp:param name="disp"	 value="ブレード型名" />
								...
								<tr>
									<td>
										<jsp:include page="/include/include_inputtextex_required.jsp">
											...
											<jsp:param name="disp"	 value="PRECUT BOARD名" />
								...
								<tr>
									<td>
										<jsp:include page="/include/include_tenkey_required.jsp">
											...
											<jsp:param name="btn_text"	value="ﾌﾟﾘカット前刃先量"/>
								...
								<tr>
									<td>
										<jsp:include page="/include/include_tenkey_required.jsp">
											...
											<jsp:param name="btn_text"	value="ﾌﾟﾘカット本数"/>
								...
								<tr>
									<td>
										<jsp:include page="/include/include_tenkey_required.jsp">
											...
											<jsp:param name="btn_text"	value="ﾌﾟﾘカット後刃先量"/>
