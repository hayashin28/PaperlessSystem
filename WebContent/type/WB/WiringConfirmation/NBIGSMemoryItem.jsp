...
<html>
	...
	<head>
		...
		<title>(メモリ品)N-BIGS配線確認チェックシート</title>
	</head>

	<body>
		<div class="block">(メモリ品)N-BIGS配線確認チェックシート</div>
		<jsp:include page="/include/include_pagetop.jsp"/>
		<form id="fm" action="<%=request.getContextPath()%>/TenkenListServlet" method="post">
			<input type="hidden" name="sheetnm" value="(メモリ品)N-BIGS配線確認チェックシート">
				...
				<table class="table table-hover">
							...
							<div class="boxContainer">
							    ...
							    <div>
									<jsp:include page="/include/include_threeswitch.jsp">
										<jsp:param name="switch1"	 value="call"/>
										<jsp:param name="switch2"	 value="input"/>
					...
					<tr>
						<td colspan=2>
							<div class="boxContainer">
								...
								<div><span id="btn_kbn_pc"    class="btn btn-info btn-lg" style="margin:8px 0px 0px 0px">PC</span></div>
								<div><span id="btn_kbn_other" class="btn btn-info btn-lg" style="margin:8px 0px 0px 0px">その他</span></div>
					...
					<tr>
						<td>
							<table border=1>
								<tr>
									<td colspan=4>①タブ品/ＣＯＬ品/MAP品</td>
								</tr>
								<tr>
									<td>区分</td><td>PKG</td><td>狙い値</td><td>管理目標値</td>
								</tr>
								<tr>
									<td >1</td><td>TSSOP</td><td>150～180</td><td>110～190</td>
								</tr>
								<tr>
									<td>2</td><td>SOJ , DILP , SOP</td><td>200～300</td><td>110～385</td>
								</tr>
								<tr>
									<td>3</td><td>基板品(MAP)</td><td>150～200</td><td>110～240</td>
								</tr>
							</table>
						</td>
						<td>
							<table border=1>
								<tr>
									<td colspan=6>②COL品(バスバーあり品)</td>
								</tr>
								<tr>
									<td>区分</td><td rowspan=2>PKG</td><td colspan=4>管理目標値</td>
								</tr>
								<tr>
									<td></td><td>バスバー越え</td><td>バスバークリアランス</td><td>バスバー打ち</td><td>ダイ外リード</td>
								<tr>
									<td>4</td><td>SOJ</td><td>500↓</td><td>60↑</td><td>400↓</td><td>130↓</td>
								</tr>
								<tr>
									<td>5</td><td>TSOP</td><td>270～350</td><td>50↑</td><td>320↓</td><td>130↓</td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
						<td colspan=2>
							<table border=1>
								<tr>
									<td colspan=5>③LOC品(バスバー無し品)</td>
								</tr>
								<tr>
									<td>区分</td><td>PKG</td><td rowspan=4>ダイ上面より高位置の<br>リードに打つアーチ高さ</td><td colspan=2>リード上面～金線トップ迄</td>
								</tr>
								<tr>
									<td rowspan=4>6</td><td rowspan=4>SOJ<br>TSOP</td><td colspan=2>130↓</td>
								<tr>
									<td rowspan=2>8MSRAM限定条件<br>ダイ上面～金線トップ迄</td><td>テープ有り370未満</td>
								</tr>
								<tr>
									<td>テープ無し270未満</td>
								</tr>
								<tr>
									<td colspan=2>ダイ面より低位置のリードに打つアーチ高さ</td><td>100～250</td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
						<td>
							<table border=1>
								<tr>
									<td colspan=3>④特殊ループ</td>
								</tr>
								<tr>
									<td>区分</td><td>PKG</td><td rowspan=2>ポイント票を確認の事</td>
								</tr>
								<tr>
									<td >7</td><td>DILP600-32</td>
								</tr>
							</table>
						</td>
					</tr>
							...
							<table border=1>
								<tr>
									...
									<td rowspan=10>
										...
										<p>マトリックス品の金属フレーム品は上ダイ1段目と下ダイ最終段目の2IC測定</p>
									</td>
								<tr/>
								<tr>
								...
								<tr>
									<td colspan=5>バスバー有り品</td>
								<tr/>
								<tr>
									<td>クリアランス</td><td>　　　　　　　　　　</td><td>　　　　　　　　　　</td><td>　　　　　　　　　　</td><td>　　　　　　　　　　</td>
								</tr>
							</table>
						</td>
					</tr>
